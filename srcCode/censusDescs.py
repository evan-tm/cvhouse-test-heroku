...
text = {
    ...
    "RACE_CITY_TITLE": 'Population by Race for Charlottesville, VA (% of Total)',
    "RACE_X_TITLE": 'Population (%)',
    "RACE_Y_TITLE": 'Racial Group',
    "RACE_NEIGHBORHOOD_TITLE": 'Population by Race for {hood} (% of Total)',
